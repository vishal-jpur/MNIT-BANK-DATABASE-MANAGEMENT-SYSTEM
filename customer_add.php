...
<body>
    <form class="add_customer_form" action="customer_add_action.php" method="post">
        ...
        <div class="flex-container">
            ...
            <div  class=container>
                <select name="branch">
                    <option value="delhi">MNIT JAIPUR</option>
                    <option value="newyork">GANDHINAGAR</option>
                    <option value="paris">DELHI</option>
                    <option value="riyadh">LUCKNOW</option>
                    <option value="moscow">MUMBAI</option>
                </select>
            </div>
        </div>
